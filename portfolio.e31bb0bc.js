...
var $author$project$Models$Model = F4(
	function (key, url, route, settings) {
		return {key: key, route: route, settings: settings, url: url};
	});
var $author$project$Routes$NotFound = {$: 'NotFound'};
var $author$project$Routes$Home = {$: 'Home'};
var $author$project$Routes$Projects = function (a) {
	return {$: 'Projects', a: a};
};
...
var $author$project$Models$init = F3(
	function (settings, url, key) {
		return _Utils_Tuple2(
			A4(
				$author$project$Models$Model,
				key,
				url,
				$author$project$Routes$parseUrl(url),
				settings),
			$elm$core$Platform$Cmd$none);
	});
...
var $author$project$Models$encodeSettings = function (settings) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$Models$setDarkMode = function (settings) {
	return _Utils_update(
		settings,
		{dark: !settings.dark});
};
var $author$project$Ports$setSettings = _Platform_outgoingPort('setSettings', $elm$core$Basics$identity);
	...
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				...
				var newSettings = $author$project$Models$setDarkMode(oldSettings);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{settings: newSettings}),
					$author$project$Ports$setSettings(
						$author$project$Models$encodeSettings(newSettings)));
		}
	});
var $author$project$Messages$ToggleDarkMode = {$: 'ToggleDarkMode'};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2('float-right', right),
							_Utils_Tuple2('float-left', !right)
						]))
				]),
			_List_fromArray(
				[icon]));
	});
var $author$project$Pages$Home$col = F2(
	function (attributes, children) {
		return A2(
			$elm$html$Html$div,
			A2(
				$elm$core$List$cons,
				$elm$html$Html$Attributes$class('w-full sm:gc-1 sm:gr-1 '),
				attributes),
			children);
	});
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $author$project$Asset$image = function (imagename) {
...
var $author$project$Pages$Home$project = F7(
	function (url, imgsrc, title, description, textColor, backgroundColor, hoverColor) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('grid gc-template-1 sm:gc-template-16 sm:gr-template-1 sm:h-screen items-center')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('gc-1 sm:gc-2-14 sm:gr-1 z-0')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									$author$project$Asset$image(imgsrc)),
									$elm$html$Html$Attributes$class('object-cover sm:h-screen-90 w-full sm:w-auto')
								]),
							_List_Nil)
						])),
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('gc-1 sm:gc-11-15 sm:gr-1 z-10 sm:shadow-2xl px-4 py-6' + backgroundColor)
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('text-4xl font-medium mb-4' + textColor)
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(title)
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('text-xl font-light mb-4' + textColor)
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$href(url),
									$elm$html$Html$Attributes$target('_blank'),
									$elm$html$Html$Attributes$class('text-xl mb-4' + (textColor + hoverColor))
								]),
							_List_fromArray(
								[
...
var $author$project$Asset$resume = $author$project$Asset$file('Resume_Seligmann_Robert.pdf');
var $author$project$Pages$Home$view = function (settings) {
	var textColor = settings.dark ? ' text-white' : ' text-black';
	var hoverColor = settings.dark ? ' shadow-dark hover:shadow-darkHover' : ' shadow-light hover:shadow-lightHover';
	var backgroundColor = settings.dark ? ' bg-gray-800' : ' bg-white';
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('w-full' + backgroundColor)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('grid sm:gc-template-2 gr-template-1 h-screen items-center justify-center overflow-hidden')
					]),
				_List_fromArray(
					[
						A2(
						$author$project$Pages$Home$col,
						_List_Nil,
						_List_fromArray(
							[
								A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('px-4 sm:px-20 ')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('text-xl font-medium my-4' + textColor)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('I am a developer based in Helsinki Finland.')
									])),
								A2(
								$elm$html$Html$p,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('I am currently working on my thesis at Aalto University')
									])),
								A2(
								$elm$html$Html$p,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href($author$project$Asset$resume),
										$elm$html$Html$Attributes$target('_blank'),
										$elm$html$Html$Attributes$class('text-xl ' + (textColor + hoverColor))
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Check out my resume.')
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('text-center text-4xl font-medium p-4' + textColor)
					]),
				_List_fromArray(
					[
...
var $author$project$Pages$NotFound$view = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('main flex flex-col')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$src(
					$author$project$Asset$image('404.png'))
				]),
			_List_Nil),
			A2(
			$elm$html$Html$h1,
			...
			_List_fromArray(
				[
					$elm$html$Html$text('You seem lost')
				]))
		]));
var $author$project$View$renderPage = function (model) {
	...
	switch (_v0.$) {
		case 'Home':
			return $author$project$Pages$Home$view(model.settings);
		case 'Projects':
			var string = _v0.a;
			return A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('should be project')
					]));
		default:
...
var $author$project$Icons$sun = A2(
	$author$project$Icons$svgFeatherIcon,
	'sun',
	_List_fromArray(
		[
...
var $author$project$View$view = function (model) {
	return {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('bg-black absolute inset-x-0 top-0')
							]),
						_List_fromArray(
							[
								A3($author$project$View$menuItem, 'https://github.com/robsel118', $author$project$Icons$github, true),
								A3($author$project$View$menuItem, 'https://www.linkedin.com/in/robert-seligmann/', $author$project$Icons$linkedin, true),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
		...
		title: 'Robert Lee Seligmann'
	};
};
var $author$project$Main$main = $elm$browser$Browser$application(
	{init: $author$project$Models$init, onUrlChange: $author$project$Messages$UrlChanged, onUrlRequest: $author$project$Messages$LinkClicked, subscriptions: $author$project$Subscriptions$subscriptions, update: $author$project$Update$update, view: $author$project$View$view});
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'dark', $elm$json$Json$Decode$bool)))({"versions":{"elm":"0.19.1"},"types":{"message":"Messages.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Messages.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"ToggleDarkMode":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});
...
app.ports.setSettings.subscribe(function (data) {
  localStorage.setItem("localSettings", JSON.stringify(data));
  localSettings = data;
});
},{"./src/Main.elm":"src/Main.elm","./styles/styles.css":"styles/styles.css"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
